...
const HomePage: React.FC = () => {
    ...
    <Link to="/">
      <img src="/Cuoidi.png" alt="Cuoidi.vn Logo" className="logo-image-home1"/>
    </Link></span>
                        </h2>
                    ...
                    <div className="services-grid">
                        <div className="service-card">
                            ...
                            <h3>Âm Nhạc</h3>
                            <p>Đa dạng lựa chọn từ ban nhạc sống đến DJ chuyên nghiệp cho đám cưới của bạn. Chúng tôi
                                cung cấp các dịch vụ âm nhạc cao cấp với các nghệ sĩ tài năng và thiết bị âm thanh hiện
                                đại.</p>
                        ...
                        <div className="service-card">
                            ...
                            <h3>Trang Trí</h3>
                            <p>Biến không gian cưới thành thiên đường với dịch vụ trang trí đẳng cấp. Đội ngũ thiết kế
                                của chúng tôi sẽ biến ý tưởng của bạn thành hiện thực với những chi tiết tinh tế.</p>
                            <ul className="service-features">
                        ...
                        <div className="service-card">
                            ...
                            <h3>Ẩm Thực</h3>
                            <p>Thực đơn đa dạng, phong phú từ các đầu bếp hàng đầu cho tiệc cưới của bạn. Chúng tôi cung
                                cấp các món ăn ngon miệng với cách trình bày đẹp mắt, đảm bảo làm hài lòng mọi thực
                                khách.</p>
                            <ul className="service-features">
                        ...
                        <div className="service-card">
                            ...
                            <h3>Trang Phục</h3>
                            <p>Váy cưới, áo dài, vest sang trọng và đẳng cấp cho cặp đôi và quan khách. Bộ sưu tập của
                                chúng tôi bao gồm các thiết kế độc đáo từ các nhà thiết kế nổi tiếng.</p>
                            <ul className="service-features">
                      ...
                      <div className="service-card">
                        ...
                        <div className="service-card">
                            ...
                            <h3>Địa Điểm</h3>
                            <p>Chúng tôi cung cấp các địa điểm tổ chức tiệc cưới sang trọng, từ khách sạn 5 sao đến các
                                khu resort đẳng cấp, phù hợp với mọi nhu cầu và ngân sách.</p>
                            <ul className="service-features">
                                <li>Khách sạn và resort cao cấp</li>
                                <li>Không gian ngoài trời lãng mạn</li>
                                <li>Phòng tiệc sang trọng</li>
                                <li>Dịch vụ hỗ trợ tổ chức sự kiện</li>
                            </ul>
                            <Link to="/services/venue" className="service-link">Tìm hiểu thêm</Link>
                        </div>
                    </div>
                </div>
            </section>
      ...
      <img src="/Cuoidi.png" alt="Cuoidi.vn Logo" className="logo-image-home1"/>
                    ...
                    <div className="features-grid">
                        <div className={`feature-card ${featureVisible ? 'visible' : ''}`} data-delay="0">
                            ...
                            <p>Ứng dụng công nghệ AI tiên tiến, giúp bạn lên kế hoạch đám cưới chi tiết và tìm kiếm dịch
                                vụ phù hợp nhất</p>
                        </div>
                        ...
                        <div className={`feature-card ${featureVisible ? 'visible' : ''}`} data-delay="1">
                            ...
                            <p>Hệ thống đối tác được thẩm định kỹ lưỡng, đảm bảo chất lượng dịch vụ tốt nhất cho ngày
                                trọng đại</p>
                        </div>
                        ...
                        <div className={`feature-card ${featureVisible ? 'visible' : ''}`} data-delay="2">
                            ...
                            <p>Tự do điều chỉnh gói dịch vụ theo ngân sách và sở thích, tạo nên đám cưới độc đáo của
                                riêng bạn</p>
                        </div>
                        ...
                        <div className={`feature-card ${featureVisible ? 'visible' : ''}`} data-delay="5">
                            ...
                            <p>98% khách hàng hài lòng với dịch vụ, cùng hàng nghìn đám cưới thành công trên toàn
                                quốc</p>
                        </div>
                    </div>
